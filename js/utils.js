...
App.utils.getClientWebinarShareMessage = function(referralLink) {
  ...
  const link = referralLink || (user?.referralCode ? App.utils.generateReferralLink(user.referralCode, 'client') : 'https://thespainconnection.com/index.html#referral?type=client');
...
App.utils.getRealtorPartnerShareMessage = function(referralLink) {
  const user = App.auth ? App.auth.getCurrentUser() : null;
  const link = referralLink || (user?.referralCode ? App.utils.generateReferralLink(user.referralCode, 'realtor') : 'https://thespainconnection.com/index.html#referral?type=realtor');
...
App.utils.getBrokerPartnerShareMessage = function(referralLink) {
  const user = App.auth ? App.auth.getCurrentUser() : null;
  const link = referralLink || (user?.referralCode ? App.utils.generateReferralLink(user.referralCode, 'broker') : 'https://thespainconnection.com/index.html#referral?type=broker');
